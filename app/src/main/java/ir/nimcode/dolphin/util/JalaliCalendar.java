...
public class JalaliCalendar implements Serializable {
     ...
     * Constructor
     */
    public JalaliCalendar(Calendar gregorian) {
    ...
    public JalaliCalendar(long timeInMillis) {

        _gregorianCalendar = Calendar.getInstance();

        _gregorianCalendar.setTimeInMillis(timeInMillis);
        ...
        _hour = _gregorianCalendar.get(Calendar.HOUR_OF_DAY);

        _minute = _gregorianCalendar.get(Calendar.MINUTE);

        _second = _gregorianCalendar.get(Calendar.SECOND);
     ...
     */
    public JalaliCalendar(String jalaliString) {
        String[] part = jalaliString.split("-");
        setPersainCalendarWithJalali(Integer.parseInt(part[0]), Integer.parseInt(part[1]),
                Integer.parseInt(part[2]));
    }

    public JalaliCalendar(JalaliCalendar jalali) {
    ...
    public JalaliCalendar(int jalaliyear, int jalalimonth, int jalaliday) {
        setPersainCalendarWithJalali(jalaliyear, jalalimonth, jalaliday);
    }

    public JalaliCalendar(int jalaliyear, int jalalimonth, int jalaliday, int jalalihour,
    ...
    /**
     * returns the persian month number_int according to specified gregorian date
     * (Months:1..12)
     */
    ...
    public static Calendar getGregorianCalendar(JalaliCalendar jalali) {
    ...
    /**
     * Returns how much days are blank at startOnlineMode
     */
    ...
    public boolean isEqual(JalaliCalendar jalali) {
    ...
    public int compareTo(JalaliCalendar jalali) {
    ...
    public String dateToString() {
        return String.format(new Locale("en"), "%d-%02d-%02d", _year, _month, _dayOfMonth);
    }

    public String timeToString() {
        return String.format(new Locale("en"), "%02d:%02d:%02d", _hour, _minute, _second);
    }

    @Override
    public String toString() {
        return String.format(new Locale("en"), "%02d:%02d:%02d %d-%02d-%02d", _hour, _minute, _second, _year, _month, _dayOfMonth);
    }
