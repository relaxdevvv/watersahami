...
public class DatabaseHelper extends SQLiteOpenHelper {
     ...
     * @param dbName
     */
    public DatabaseHelper(Context context, String assetName, String dbName) {
     ...
     * @param dbName
     */
    public DatabaseHelper(Context context, Uri dbUri, String dbName) {
        super(context, dbName, null, DB_VERSION);
        mContext = context;
        mDbPath = getDatabaseDir() + dbName;
        mAssetName = null;
    ...
    public void insertStudyArea(long code, String name, String polygon) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL(
                "INSERT INTO " + StudyArea.TABLE_NAME +
                        " ( " + StudyArea.COLUMN_CODE + "," + StudyArea.COLUMN_NAME + "," + StudyArea.COLUMN_POLYGON + " )" +
                        " values " +
                        " ( ? , ? , " + polygon + " ) ;",
    ...
    public StudyArea getStudyAreaFromPoint(String point) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(
                "SELECT * FROM " + StudyArea.TABLE_NAME + " WHERE Contains( polygon , " + point + ") ;",
                null);
//        Log.d("TAG", "getStudyAreaFromPoint: " + "SELECT * FROM " + StudyArea.TABLE_NAME + " WHERE Contains( polygon ," + point + ") ;");
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                ...
                studyArea = new StudyArea(id, code, name);
            }
        }
        db.close();
        return studyArea;
